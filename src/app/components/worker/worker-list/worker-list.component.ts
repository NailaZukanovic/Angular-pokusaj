...
export class WorkerListComponent implements OnInit {
  ...
  displayedColumns = ['Id', 'JMBG', 'FirstName', 'LastName', 'ParentName', 'Address', 'PhoneNumbers', 'EmailAddresses', 'Role', 'HiredFromDate', 'HiredUntilDate', 'ExpoId', 'IsExpoChief', 'Actions']
